    ...
    public sealed class MsgLoginUserExchangeEx : MsgLoginUserExchangeEx<GameClient>
    {
        ...
        public override async Task ProcessAsync(GameClient client)
        {
            ...
            if (Data.Response != SUCCESS)
            {
                ...
                await request.Client.DisconnectWithRejectionCodeAsync(Long.Network.Packets.Game.MsgConnectEx<Login.LoginClient>.RejectionCode.PleaseTryAgainLater);
                return;
            }
            ...
            await request.Client.SendAsync(new MsgConnectEx(realm.IpAddress, (uint)realm.Port, (uint)Data.Token, request.Client.Seed));
