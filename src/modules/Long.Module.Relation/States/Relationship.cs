...
namespace Long.Module.Relation.States
{
    public sealed class Relationship : IRelation
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            {
                Relation<DbFriend> friend = new(dbf.TargetId, dbf.TargetName, dbf);
            ...
            {
                Relation<DbEnemy> enemy = new (dbe.TargetId, dbe.TargetName, dbe);
        ...
        public async Task<bool> AddFriendAsync(uint idTarget)
        {
            ...
            Relation<DbFriend> targetFriend = new(user.Identity, user.Name, new DbFriend
            {
        ...
        public Task SendEnemyInfoAsync(uint idTarget)
        {
            ...
            return user.SendAsync(new MsgFriendInfo
            {
                ...
                Profession = (byte)(target?.Profession ?? 0)
            });
        }
        ...
        {
            //TODO: idk how exactly to do it... probably i need to force on online friends too.
