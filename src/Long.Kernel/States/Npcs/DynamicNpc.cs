...
namespace Long.Kernel.States.Npcs
{
    public sealed class DynamicNpc : BaseNpc
    {
        ...
        {
            await SetAttributesAsync(ClientUpdateType.Life, 0);
        ...
        public override uint IncomeValue 
        {
            get => npc.IncomeValue;
            set => npc.IncomeValue = value;
        }

        public override ulong CurrentCost
        {
            get => npc.Price; 
            set => npc.Price = value;
        }

        public override ulong InitialCost 
        {
            get => npc.InitialPrice;
            set => npc.InitialPrice = value;
        }

        public override ulong CurrentDeposit
        {
            get => npc.Deposit;
            set => npc.Deposit = value;
        }
        #endregion
        ...
        public override string DefaultOwnerName
        {
        ...
        public override Task SendSpawnToAsync(Character player)
        {
            if (MaxLife == 0)
            {
                return player.SendAsync(new MsgNpcInfo()
                {
                    Identity = Identity,
