...
namespace Long.Kernel.States.Npcs
{
    public abstract class BaseNpc : Role
    {
        ...
        public const int
            ...
            ROLE_AUCTION_NPC = 30,			// 骑宠合成NPC
            ROLE_FAMILY_OCCUPY_NPC = 31,
            ROLE_MARKETSALE_NPC = 33,
        ...
        public bool IsAuctionNpc()
        {
            return Type == ROLE_AUCTION_NPC;
        }
        public bool IsBoothNpc()
        {
            return Type == ROLE_MARKETSALE_NPC;
        }
        ...
        public bool IsGoal()
        {
            return Type == ROLE_WEAPONGOAL_NPC || Type == ROLE_WEAPONGOAL_NPC;
        }
        ...
        public virtual string DefaultOwnerName { get; set; }
        ...
        public List<DbGoodsReminiscence> ShopGoodsEx = new();
        ...
        public virtual uint Task0 { get; protected set; }
        public virtual uint Task1 { get; protected set; }
        public virtual uint Task2 { get; protected set; }
        public virtual uint Task3 { get; protected set; }
        public virtual uint Task4 { get; protected set; }
        public virtual uint Task5 { get; protected set; }
        public virtual uint Task6 { get; protected set; }
        public virtual uint Task7 { get; protected set; }
        ...
        public virtual uint IncomeValue { get; set; }
        public virtual ulong InitialCost { get; set; }
        public virtual ulong CurrentCost { get; set; }
        public virtual ulong CurrentDeposit { get; set; }
