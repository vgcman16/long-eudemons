...
namespace Long.Kernel.Managers
{
    public class ServerStatisticManager
    {
        ...
        public static void DropGem(ItemBase.SocketGem socketGem)
        {
            /*switch (socketGem)
            {
                case ItemBase.SocketGem.NormalPhoenixGem:
                case ItemBase.SocketGem.RefinedPhoenixGem:
                case ItemBase.SocketGem.SuperPhoenixGem:
                    dynaGlobalDataCache[GEMS_DROP1_TOTAL].Data0 += 1;
                    dynaGlobalDataCache[GEMS_DROP1_SESSION].Data0 += 1;
                    break;
                case ItemBase.SocketGem.NormalDragonGem:
                case ItemBase.SocketGem.RefinedDragonGem:
                case ItemBase.SocketGem.SuperDragonGem:
                    dynaGlobalDataCache[GEMS_DROP1_TOTAL].Data1 += 1;
                    dynaGlobalDataCache[GEMS_DROP1_SESSION].Data1 += 1;
                    break;
                case ItemBase.SocketGem.NormalFuryGem:
                case ItemBase.SocketGem.RefinedFuryGem:
                case ItemBase.SocketGem.SuperFuryGem:
                    dynaGlobalDataCache[GEMS_DROP1_TOTAL].Data2 += 1;
                    dynaGlobalDataCache[GEMS_DROP1_SESSION].Data2 += 1;
                    break;
                case ItemBase.SocketGem.NormalRainbowGem:
                case ItemBase.SocketGem.RefinedRainbowGem:
                case ItemBase.SocketGem.SuperRainbowGem:
                    dynaGlobalDataCache[GEMS_DROP1_TOTAL].Data3 += 1;
                    dynaGlobalDataCache[GEMS_DROP1_SESSION].Data3 += 1;
                    break;
                case ItemBase.SocketGem.NormalKylinGem:
                case ItemBase.SocketGem.RefinedKylinGem:
                case ItemBase.SocketGem.SuperKylinGem:
                    dynaGlobalDataCache[GEMS_DROP1_TOTAL].Data4 += 1;
                    dynaGlobalDataCache[GEMS_DROP1_SESSION].Data4 += 1;
                    break;
                case ItemBase.SocketGem.NormalVioletGem:
                case ItemBase.SocketGem.RefinedVioletGem:
                case ItemBase.SocketGem.SuperVioletGem:
                    dynaGlobalDataCache[GEMS_DROP1_TOTAL].Data5 += 1;
                    dynaGlobalDataCache[GEMS_DROP1_SESSION].Data5 += 1;
                    break;
                case ItemBase.SocketGem.NormalMoonGem:
                case ItemBase.SocketGem.RefinedMoonGem:
                case ItemBase.SocketGem.SuperMoonGem:
                    dynaGlobalDataCache[GEMS_DROP2_TOTAL].Data0 += 1;
                    dynaGlobalDataCache[GEMS_DROP2_SESSION].Data0 += 1;
                    break;
                case ItemBase.SocketGem.NormalTortoiseGem:
                case ItemBase.SocketGem.RefinedTortoiseGem:
                case ItemBase.SocketGem.SuperTortoiseGem:
                    dynaGlobalDataCache[GEMS_DROP2_TOTAL].Data1 += 1;
                    dynaGlobalDataCache[GEMS_DROP2_SESSION].Data1 += 1;
                    break;
                case ItemBase.SocketGem.NormalThunderGem:
                case ItemBase.SocketGem.RefinedThunderGem:
                case ItemBase.SocketGem.SuperThunderGem:
                    dynaGlobalDataCache[GEMS_DROP2_TOTAL].Data2 += 1;
                    dynaGlobalDataCache[GEMS_DROP2_SESSION].Data2 += 1;
                    break;
                case ItemBase.SocketGem.NormalGloryGem:
                case ItemBase.SocketGem.RefinedGloryGem:
                case ItemBase.SocketGem.SuperGloryGem:
