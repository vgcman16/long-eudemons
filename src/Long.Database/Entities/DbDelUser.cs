...
namespace Long.Database.Entities
{
    ...
    public class DbDelUser
    {
        ...
        [Column("reg_time")] public virtual int RegisterTime { get; set; }
        ...
        [Column("wood")] public virtual int Wood { get; set; }
        [Column("stone")] public virtual int Stone { get; set; }
        ...
        [Column("deification")] public virtual byte Dedication { get; set; }
