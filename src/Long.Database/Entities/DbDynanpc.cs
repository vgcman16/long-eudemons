namespace Long.Database.Entities
{
    ...
    public class DbDynanpc
    {
        ...
        [Column("initial_price")] public virtual ulong InitialPrice { get; set; }
        [Column("price")] public virtual ulong Price { get; set; }
        [Column("deposit")] public virtual ulong Deposit { get; set; }
        [Column("income_value")] public virtual uint IncomeValue { get; set; }
    }
}
