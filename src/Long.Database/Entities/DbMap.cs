namespace Long.Database.Entities
{
    ...
    public class DbMap
    {
        ...
        [Column("province_id")] public virtual uint ProvinceId { get; set; }
        [Column("Level_Challenge")] public virtual uint LevelChallenge { get; set; }
        [Column("social_class")] public virtual uint SocialClass { get; set; }
        [Column("cell_load")] public virtual uint CellLoad { get; set; }
    }
}