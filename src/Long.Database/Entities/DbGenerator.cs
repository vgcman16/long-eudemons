namespace Long.Database.Entities
{
    ...
    public class DbGenerator
    {
        ...
        [Column("grid")] public virtual int MaxNpc { get; set; }
        ...
        [Column("max_amount")] public virtual int MaxAmount { get; set; }
        //[Column("cluster_type")] public virtual bool ClusterType { get; set; }
        [Column("Level_Challenge")] public virtual int Attribute { get; set; }
        [Column("copymapflag")] public virtual int Data { get; set; }
    }
}
